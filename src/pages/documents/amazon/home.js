...
function DocumentHome () {
    ...
    const sendUserMessage = async (event) => {
      ...
      try {
        const rawResponse = await fetch("http://localhost:80/unified-chat", {
          method: "POST",
          headers: {
        ...
        const aiResponse = response.result.pineconeAnswer; // Access the output key within the result property
            ...
            <div className="tyn-appbar-wrap">
                <div className="tyn-appbar-logo">
                    <a className="tyn-logo" href="index-2.html">
                        <img src="images/padd_white_logo.png" alt="" />                    
                    </a>
                </div>
                {/* <!-- tyn-logo --> */}
                <div className="tyn-appbar-content">
                    
                {folderName}... your personal shopping assistant
                                            ...
                                            <ul className="d-flex align-items-center gap gap-3">
                                                <li className="inline-flex">
                                                    <div className="form-check">
                                                        ...
                                                        <label className="form-check-label small" for="dark"> On </label>
                                                    </div>
                                                </li>
                                                <li className="inline-flex">
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="radio" name="themeMode" id="light" value="light" checked />
                                                        <label className="form-check-label small" for="light"> Off </label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div className="w-100">
                        <ul className="row gx-3">
                            ...
                            <button className="btn btn-light tyn-size-lg w-100 flex-column py-2 pt-3">
                                    ...
                                    <span className="small text-nowrap mt-n1">Log out</span>
                                    </button>
                            </li>
                            <li className="col-6">
                                <button className="btn btn-light tyn-size-lg w-100 flex-column py-2 pt-3">
                    ...
                    <div className="conversation tyn-qa" style={{ maxHeight: '700px' }}>
                        ...
                        <div>
                            {messages.map((message) => (
                                <div className={`tyn-qa ${message.sender === "AI" ? "ai-message" : "user-message"}`} key={message.id}>
                                <div className="tyn-qa-item">
                                    <div className="tyn-qa-avatar">
                                    <div className="tyn-media tyn-size-md">
                                        <img src={message.sender === "AI" ? "/images/avatar/bot-1.jpg" : "/images/avatar/1.jpg"} alt="" width={2} height={100} />
                                    </div>
                                    </div>
                                    <div className="tyn-qa-message tyn-text-block">
                                    <div className={`message ${message.sender === "AI" ? "ai-message" : "user-message"}`}>
                                        {message.text}
                                    </div>
                                    </div>
                                </div>
                ...
                <div className="tyn-quick-chat-reply js-scroll-to-end">
                    <div className="tyn-reply tyn-reply-quick" id="tynQuickReply">
                        ...
                        <div className="tyn-reply-item outgoing">
                            <div className="tyn-reply-group">
                                <div className="tyn-reply-bubble">
                                    <div className="tyn-reply-text"> Yes, you can reset your password online. Go to the login page, click on "Forgot Password," and follow the instructions to reset it. </div>
                                    {/* <!-- tyn-reply-text --> */}
                                </div>
                                {/* <!-- .tyn-reply-bubble --> */}
                            </div>
