                    ...
                    <div class="tyn-reply tyn-reply-quick" id="tynQuickReply">
                        <div class="tyn-reply-item outgoing">
                            <div class="tyn-reply-group">
                                ...
                                // <!-- .tyn-reply-bubble --> */}
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-text"> These article helps. </div>
                                    {/* <!-- tyn-reply-text --> */}
                                </div>
                                {/* 
                                // <!-- .tyn-reply-bubble --> */}
                        ...
                        <div class="tyn-reply-item outgoing">
                            <div class="tyn-reply-group">
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-text"> Yes, you can reset your password online. Go to the login page, click on "Forgot Password," and follow the instructions to reset it. </div>
                                    {/* <!-- tyn-reply-text --> */}
                                </div>
                                {/* 
                                // <!-- .tyn-reply-bubble --> */}
