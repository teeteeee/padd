...
const DynamicHomePage = () => {
  ...
  // Use the tokens for your desired purpose
...
//   console.log("user1 in homepage", user);
//   if (user === null) {
...
//   }
  ...
  const sendUserMessage = async (event) => {
    ...
    try {
      const rawResponse = await fetch(`http://localhost:80/home/${folderName}`, {
        method: "POST",
        headers: {
                              ...
                              <div className="tyn-media-col">
                                <div className="tyn-media-row">
                                  <span className="message">
                                    <strong>Phillip Burke</strong> Sent message
                                  </span>
                                </div>
                                <div className="tyn-media-row">
                          ...
                          <li>
                            <div className="tyn-media-group align-items-start">
                              ...
                              <div className="tyn-media-col">
                                <div className="tyn-media-row">
                                  <span className="message">
                                    <strong>Thomas Poulain</strong> Added You
                                  </span>
                                </div>
                                <div className="tyn-media-row has-dot-sap">
                          ...
                          <li>
                            <div className="tyn-media-group">
                              ...
                              <div className="tyn-media-col">
                                <div className="tyn-media-row">
                                  <span className="message">
                                    <strong>Gabriel Schmitz</strong> Sent
                                    message
                                  </span>
                                </div>
                                <div className="tyn-media-row has-dot-sap">
                  ...
                  <div className="tyn-qa-item" style={{ background: "white" }}>
                    ...
                    <div className="tyn-qa-message tyn-text-block">
                      <p>
                        ...
                        assistant. Welcome to our store. How can I assist you
                        today?
                      </p>
                    </div>
                  </div>
